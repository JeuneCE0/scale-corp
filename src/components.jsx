...
export const SB_ADMIN=[
 ...
 {id:"saas",icon:"☁️",label:"SaaS",accent:"#38bdf8",children:[
  {tab:30,icon:"⚙️",label:"Paramètres SaaS"},
  {tab:31,icon:"👥",label:"Clients SaaS"},
  {tab:14,icon:"🔐",label:"Accès SaaS"},
 ]},
];
