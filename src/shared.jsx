...
export const C_DARK={bg:"#06060b",card:"#0e0e16",card2:"#131320",brd:"#1a1a2c",brdL:"#24243a",acc:"#FFAA00",accD:"rgba(255,170,0,.12)",g:"#34d399",gD:"rgba(52,211,153,.1)",r:"#f87171",rD:"rgba(248,113,113,.1)",o:"#fb923c",oD:"rgba(251,146,60,.1)",b:"#60a5fa",bD:"rgba(96,165,250,.1)",t:"#e4e4e7",td:"#9ca3af",tm:"#8b8b9e",v:"#a78bfa",vD:"rgba(167,139,250,.1)"};
...
@media(max-width:992px){.sidebar-desktop{width:180px !important;min-width:180px !important}.main-content{margin-left:0 !important}.admin-soc-selector{left:190px !important}.rg-auto{grid-template-columns:repeat(auto-fit,minmax(140px,1fr)) !important}.rg4{grid-template-columns:1fr 1fr 1fr !important}.admin-responsive-grid{grid-template-columns:1fr !important}.period-selector-btns button{padding:6px 10px !important;font-size:9px !important}}
@media(max-width:768px){.sidebar-desktop{display:none !important}.main-content{margin-left:0 !important;padding:10px !important;padding-top:48px !important;padding-bottom:76px !important}.ai-desktop-bubble{display:none !important}.ai-chat-panel{display:none !important}.mobile-header{display:flex !important}.mobile-bottom-nav{display:flex !important}.kpi-grid-responsive{grid-template-columns:1fr 1fr !important}.chart-responsive{min-height:180px}.tx-list-mobile .tx-detail{display:none}.rg4{grid-template-columns:1fr 1fr !important}.rg2{grid-template-columns:1fr !important}.rg3{grid-template-columns:1fr !important}.rg-auto{grid-template-columns:1fr 1fr !important}.glass-card,.glass-card-static{min-width:0 !important;overflow:hidden}.admin-grid{grid-template-columns:1fr !important}.admin-card{min-width:auto !important}.admin-stats-row{grid-template-columns:1fr !important;gap:8px !important}.pulse-grid{grid-template-columns:1fr !important}.pulse-left,.pulse-right{display:none !important}.pulse-center{grid-column:1 !important}.admin-responsive-grid{grid-template-columns:1fr !important}.admin-responsive-2col{grid-template-columns:1fr 1fr !important}table{display:block;overflow-x:auto;-webkit-overflow-scrolling:touch;font-size:12px !important}table th,table td{white-space:nowrap;padding:8px 10px !important}table::-webkit-scrollbar{height:4px}table::-webkit-scrollbar-thumb{background:${C.brd};border-radius:4px}.admin-soc-grid{grid-template-columns:1fr !important}.admin-soc-selector{left:10px !important;top:50px !important}.modal-wide{width:95vw !important;max-width:95vw !important}.glass-modal{width:95vw !important;max-width:95vw !important;padding:14px !important}.ai-chat-panel{width:92vw !important;right:0 !important;max-width:none !important}.notif-panel{width:88vw !important;right:0 !important}.recharts-wrapper{font-size:10px !important}.page-wrap{padding:12px 10px !important}.rg2k{grid-template-columns:1fr 1fr !important}.ob-sidebar{display:none !important}.ob-content{padding:14px 10px !important}.deal-flow-stages{overflow-x:auto !important;-webkit-overflow-scrolling:touch;scroll-snap-type:x mandatory;padding-bottom:8px}.deal-flow-stages::-webkit-scrollbar{height:4px}.deal-flow-stages::-webkit-scrollbar-thumb{background:${C.brd};border-radius:4px}.deal-flow-stages>div{scroll-snap-align:start;min-width:160px !important;flex:0 0 160px !important}body{font-size:14px !important}.glass-card-static,.glass-card{font-size:14px}.kpi-val{font-size:22px !important}.kanban-board{overflow-x:auto !important;-webkit-overflow-scrolling:touch;scroll-snap-type:x mandatory;padding-bottom:8px;scroll-behavior:smooth}.kanban-board::-webkit-scrollbar{height:4px}.kanban-board::-webkit-scrollbar-thumb{background:${C.brd};border-radius:4px}.kanban-board>div{scroll-snap-align:start;min-width:200px !important;flex:0 0 75vw !important}.panel-tabs{overflow-x:auto !important;-webkit-overflow-scrolling:touch;flex-wrap:nowrap !important;padding-bottom:4px;scroll-behavior:smooth;-ms-overflow-style:none;scrollbar-width:none}.panel-tabs::-webkit-scrollbar{display:none}.panel-tabs button{flex-shrink:0 !important;white-space:nowrap;min-height:40px}.funnel-scroll{overflow-x:auto !important;-webkit-overflow-scrolling:touch;padding-bottom:6px;scroll-behavior:smooth}.funnel-scroll::-webkit-scrollbar{height:3px}.funnel-scroll::-webkit-scrollbar-thumb{background:${C.brd};border-radius:3px}.period-selector{flex-direction:column !important;align-items:stretch !important;gap:8px !important}.period-nav{justify-content:center !important}.period-selector-btns{width:100% !important;display:flex !important}.period-selector-btns button{flex:1 !important;padding:8px 6px !important;font-size:10px !important;min-height:38px}.burn-grid{grid-template-columns:1fr 1fr 1fr !important;gap:6px !important}.health-score-grid{flex-wrap:wrap !important;gap:10px !important;justify-content:center !important}.ad-sim-card{padding:14px !important}.ad-sim-card .offer-row{flex-direction:column !important;gap:6px !important}.ad-sim-card .offer-inputs{flex-wrap:wrap !important;gap:6px !important}.deals-recent{font-size:11px !important}.deals-recent>div{padding:8px 10px !important}.sim-summary{grid-template-columns:1fr 1fr !important}}
@media(max-width:480px){.rg-auto{grid-template-columns:1fr 1fr !important}.rg2{grid-template-columns:1fr !important}.rg2k{grid-template-columns:1fr !important}.rg4{grid-template-columns:1fr !important}.rg3{grid-template-columns:1fr !important}.glass-modal{width:98vw !important;max-width:98vw !important;padding:12px !important;margin:8px !important}.modal-wide{width:98vw !important;max-width:98vw !important}.kpi-grid-responsive{grid-template-columns:1fr !important}.admin-responsive-2col{grid-template-columns:1fr !important}.page-wrap{padding:8px 6px !important}.main-content{padding:8px !important;padding-top:48px !important;padding-bottom:70px !important}body{font-size:14px !important}h1{font-size:18px !important}h2{font-size:15px !important}h3{font-size:14px !important}.glass-card-static,.glass-card{font-size:14px}.kanban-board>div{flex:0 0 85vw !important}.burn-grid{grid-template-columns:1fr !important}.sim-summary{grid-template-columns:1fr !important}.health-score-grid>div{min-width:60px}}
@media(min-width:769px){.mobile-header{display:none !important}.mobile-bottom-nav{display:none !important}.mobile-ai-fullscreen{display:none !important}}
@media(max-width:768px){.mobile-header{padding:env(safe-area-inset-top,8px) 16px 10px !important;padding-top:calc(env(safe-area-inset-top,8px) + 4px) !important}.mobile-ai-fab{z-index:10}}
