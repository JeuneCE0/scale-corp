...
@media(max-width:992px){.sidebar-desktop{width:180px !important;min-width:180px !important}.main-content{margin-left:0 !important}.admin-soc-selector{left:190px !important}.rg-auto{grid-template-columns:repeat(auto-fit,minmax(140px,1fr)) !important}.rg4{grid-template-columns:1fr 1fr 1fr !important}.admin-responsive-grid{grid-template-columns:1fr !important}}
...
@media(max-width:480px){.rg-auto{grid-template-columns:1fr !important}.rg2{grid-template-columns:1fr !important}.rg2k{grid-template-columns:1fr !important}.rg4{grid-template-columns:1fr !important}.rg3{grid-template-columns:1fr !important}.glass-modal{width:98vw !important;max-width:98vw !important;padding:12px !important;margin:8px !important}.modal-wide{width:98vw !important;max-width:98vw !important}.kpi-grid-responsive{grid-template-columns:1fr !important}.admin-responsive-2col{grid-template-columns:1fr !important}.page-wrap{padding:8px 6px !important}.main-content{padding:8px !important;padding-top:48px !important;padding-bottom:70px !important}body{font-size:14px !important}h1{font-size:18px !important}h2{font-size:15px !important}h3{font-size:14px !important}.glass-card-static,.glass-card{font-size:14px}}
