...
export const TIMING={MODAL_Z:1000,CELEBRATION_Z:10000,FEEDBACK_MS:2000,CELEB_CLOSE_MS:5000,GHL_POLL_MS:30000,REV_POLL_MS:60000,FORCE_UPDATE_MS:60000,MSG_POLL_MS:5000,SLIDE_INTERVAL_MS:3000};
...
@keyframes kpiGlow{0%{box-shadow:0 0 0 0 var(--glow-color,rgba(255,170,0,.15))}50%{box-shadow:0 0 20px 2px var(--glow-color,rgba(255,170,0,.12))}100%{box-shadow:0 0 0 0 var(--glow-color,rgba(255,170,0,.15))}}
@keyframes numberPop{0%{transform:scale(1)}50%{transform:scale(1.08)}100%{transform:scale(1)}}
@keyframes gradientShift{0%{background-position:0% 50%}50%{background-position:100% 50%}100%{background-position:0% 50%}}
@keyframes borderGlow{0%,100%{border-color:rgba(255,255,255,.06)}50%{border-color:var(--glow-color,rgba(255,170,0,.2))}}
@keyframes sparkline{from{stroke-dashoffset:200}to{stroke-dashoffset:0}}
@keyframes funnelReveal{from{opacity:0;transform:scaleX(0)}to{opacity:1;transform:scaleX(1)}}
@keyframes trophyBounce{0%,100%{transform:translateY(0) rotate(0)}25%{transform:translateY(-3px) rotate(-3deg)}75%{transform:translateY(-1px) rotate(3deg)}}
@keyframes gradientBorder{0%{border-image-source:linear-gradient(0deg,rgba(255,170,0,.3),rgba(96,165,250,.3))}50%{border-image-source:linear-gradient(180deg,rgba(255,170,0,.3),rgba(167,139,250,.3))}100%{border-image-source:linear-gradient(360deg,rgba(255,170,0,.3),rgba(96,165,250,.3))}}
.kpi-v2{position:relative;overflow:hidden;transition:all .35s cubic-bezier(.4,0,.2,1)}.kpi-v2:hover{transform:translateY(-3px);box-shadow:0 12px 40px rgba(0,0,0,.4)}.kpi-v2:hover .kpi-v2-glow{opacity:1}
.kpi-v2-glow{position:absolute;top:-50%;left:-50%;width:200%;height:200%;background:radial-gradient(circle,var(--glow-color,rgba(255,170,0,.06)) 0%,transparent 70%);opacity:0;transition:opacity .4s ease;pointer-events:none}
.kpi-v2-value{transition:all .3s ease}.kpi-v2:hover .kpi-v2-value{transform:scale(1.04)}
.hero-gradient{background:linear-gradient(135deg,rgba(255,170,0,.08) 0%,rgba(96,165,250,.05) 50%,rgba(167,139,250,.06) 100%);border:1px solid rgba(255,170,0,.12);animation:borderGlow 4s ease infinite}
.section-divider{height:1px;background:linear-gradient(90deg,transparent,rgba(255,170,0,.2),rgba(96,165,250,.15),transparent);margin:24px 0}
.funnel-stage{transform-origin:center;animation:funnelReveal .5s cubic-bezier(.4,0,.2,1) both}
.funnel-stage:nth-child(1){animation-delay:0s}.funnel-stage:nth-child(2){animation-delay:.1s}.funnel-stage:nth-child(3){animation-delay:.2s}.funnel-stage:nth-child(4){animation-delay:.3s}
.trophy-anim:hover{animation:trophyBounce .5s ease}
.portfolio-card-v2{position:relative;overflow:hidden;transition:all .35s cubic-bezier(.4,0,.2,1)}.portfolio-card-v2:hover{transform:translateY(-4px);box-shadow:0 16px 48px rgba(0,0,0,.45)}.portfolio-card-v2::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:var(--card-accent,${C.acc});opacity:.7;border-radius:16px 16px 0 0}
.leaderboard-row{transition:all .25s ease}.leaderboard-row:hover{transform:translateX(4px);background:rgba(255,170,0,.04) !important}
.stat-mini-chart{display:flex;align-items:flex-end;gap:1px;height:20px}.stat-mini-chart span{display:block;border-radius:1px 1px 0 0;min-width:3px;background:var(--bar-color,${C.acc});transition:height .4s cubic-bezier(.4,0,.2,1)}
.welcome-banner{background:linear-gradient(135deg,rgba(255,170,0,.06) 0%,rgba(14,14,22,.8) 40%,rgba(167,139,250,.04) 100%);border:1px solid rgba(255,170,0,.1);border-radius:20px;padding:24px 28px;position:relative;overflow:hidden}
.welcome-banner::after{content:'';position:absolute;top:-50%;right:-20%;width:60%;height:200%;background:radial-gradient(circle,rgba(255,170,0,.04) 0%,transparent 60%);pointer-events:none}
